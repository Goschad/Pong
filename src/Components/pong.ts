import Map1 from './asset/Map/tunsinge.png';
import Map2 from './asset/Map/Rick.png';
import Map3 from './asset/Map/Giga.png';

import Invisibility from './asset/PowerUp/Invisible.png';
import Nerf from './asset/PowerUp/Nerf.png';
